...
var $author$project$Main$userLoggedIn = _Platform_incomingPort('userLoggedIn', $elm$json$Json$Decode$string);
var $author$project$Main$userLoggedOut = _Platform_incomingPort('userLoggedOut', $elm$json$Json$Decode$string);
...
var $author$project$User$Decoder$loginStatusToValue = function (status) {
	switch (status.$) {
		...
		case 'UnAuthorised':
			return $elm$json$Json$Encode$string('UnAuthorised');
		default:
			return $elm$json$Json$Encode$string('Disconnected');
	}
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'uid',
				$elm$json$Json$Encode$string(model.uid)),
				_Utils_Tuple2(
				'name',
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(pic)
					]),
				_List_Nil),
				A2(
