...
var _user$project$Facebook$login = _elm_lang$core$Native_Platform.outgoingPort(
	'login',
	function (v) {
		return {};
	});
var _user$project$Facebook$logout = _elm_lang$core$Native_Platform.outgoingPort(
	'logout',
	function (v) {
		return {};
	});
...
var _user$project$User$nameDecoder = function (json) {
	return A2(
...
var _user$project$User$newUser = F2(
	function (name, picture) {
		return {name: name, url: picture, loginStatus: _user$project$User$Connected, userType: _user$project$User$Client};
	});
var _user$project$User$userDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$User$newUser,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(
		...
		switch (_p0.ctor) {
			...
			case 'Login':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Facebook$login(
						{})
				};
			case 'Logout':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Facebook$logout(
						{})
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Main$loggedInHtml = function (pic) {
	return A2(
...
var _user$project$Main$loggedOutHtml = A2(
	_elm_lang$html$Html$button,
	{
		ctor: '::',
	...
	if (_p3.ctor === 'Connected') {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$loggedInHtml(app.userModel.url),
					_1: {ctor: '[]'}
				}
			});
	} else {
